                            ...
                            <table id="default-ordering" class="table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$product->name}}</td>
                                        <td><img src="{{ url('uploads/products').'/'.$product->image}}" style="height: 72px;"></td>
                                        <td>{{$product->price}}</td>
                                        <td class="text-center"><button class="btn btn-primary btn-sm" onclick="location.href='{{ url('products/edit/'.$product->id)}}'">Edit</button>
                                        <button class="btn btn-primary btn-sm" onclick="location.href='{{ url('products/edit/'.$product->id)}}'">Delete</button> </td>
                                    </tr>
                                    @endforeach
                                </tbody>
