...
<!-- Mirrored from designreset.com/cork/ltr/demo4/auth_login_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Jun 2021 08:23:27 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="{{url('theme')}}/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="{{url('theme')}}/assets/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="{{url('theme')}}/assets/css/forms/switches.css">
</head>
<body class="form">
                        ...
                        <form action="{{url('login')}}" method="POST" class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control" placeholder="e.g JohnDoe@123.com">
                                </div>
