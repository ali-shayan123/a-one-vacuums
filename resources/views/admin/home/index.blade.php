                        ...
                        <div class="widget-content widget-content-area br-6">
                            <table id="default-ordering" class="table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">{{$home1->id}}</td>
                                        <td><img src="{{ url('uploads/home').'/'.$home1->banner}}" style="height: 72px;"></td>
                                        <td>{{$home1->welcome}}</td>
                                        <td>{{$home1->span}}</td>
                                        <td>{{$home1->tagline}}</td>
                                        <td>{{$home1->describe}}</td>
                            ...
                            <center><button class="btn btn-primary btn-sm" onclick="location.href='{{ url('/home/edit/'.$home1->id)}}'">Edit</button></center>
                        </div>
                    </div>
